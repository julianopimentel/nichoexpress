...
.logo-container-greenbygreen {

}

.logo-container-greenbygreen img {
    background: #<?php echo ($frontpage_bg_lcolor ?: '4DAC71'); ?>;
...
.admin-logo-container-greenbygreen img {
    background: #3d3d3d;
    border: 1px dashed #333;
    margin: 10px 0;
    padding: 10px;
...
.greenbygreen-user-list-admin-type-normal {
	display: none;
}
.greenbygreen-user-list-admin-type-admin {
	font-size: smaller;
	color: red;
}
.greenbygreen-user-list-admin-type-moderator {
	font-size: smaller;
	color: orange;
}
.greenbygreen-user-list-admin-type-verified {
	font-size: smaller;
	color: blue;
}
.greenbygreen-user-list-admin-type-banned {
	font-size: smaller;
	color: black;
}
