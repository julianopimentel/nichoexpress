...
$iscover = '';
$groupname_class = 'group-name group-name-without-cover';
...
<div class="ossn-group-profile">
    ...
    <div class="col-md-12">
        ...
        if ($cover) {
            ?>
            <div class="<?php echo $cover_class; ?>" id="container">
               <?php if ($params['group']->owner_guid == ossn_loggedin_user()->guid || ossn_isAdminLoggedin()) { ?>
		...
		<?php } ?>
			...
			<div class="<?php echo $groupname_class; ?>">
