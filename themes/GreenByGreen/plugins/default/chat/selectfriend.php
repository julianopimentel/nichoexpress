...
-->	
				<div class="ossn-chat-inline-table ossn-chat-icon-shrink" title="Shrink chat"></div>
				 
                &nbsp;<div class="ossn-chat-inline-table ossn-chat-icon-close ossn-chat-tab-close" title="Close chat" id="ftab-c<?php echo $user->guid; ?>"
                     onclick="Ossn.ChatTerminateTab(<?php echo $user->guid; ?>);">
                </div>
            </div>
        </div>
 		<script>
    ...
    <div class="inner friend-tab <?php echo $tab_class; ?>" id="ftab<?php echo $user->guid; ?>"
        ...
        <div id="ossnchat-ustatus-<?php echo $user->guid; ?>" class="<?php echo $status; ?>">
            <div class="ossn-chat-inner-text">
                <?php echo $user->fullname; ?><span class="ossn-chat-icon-expend" title="Popout Chat"></span>
           </div>
		</div>
    </div>
