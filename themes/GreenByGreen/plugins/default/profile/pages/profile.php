...
$fullname_class = 'user-fullname user-fullname-without-cover';

if(!empty($coverp[0])){
	$cover_top = "top:{$coverp[0]};";
	$fullname_class = 'user-fullname';
}
if(!empty($coverp[1])){
...
$cover_class = 'profile-cover';
if (ossn_loggedin_user()->guid == $user->guid) {
	$cover_class = $cover_class . ' cover-owner';
}
?>
    	...
    	<div class="col-md-12">
			<div class="<?php echo $class; ?>">
				<div class="top-container">
					<div id="container" class="<?php echo $cover_class; ?>">
					...
					<div class="<?php echo $fullname_class; ?>"><?php echo $user->fullname; ?></div>
                    <?php echo ossn_plugin_view('profile/role', array('user' => $user, 'class' => $fullname_class)); ?>
					<div id='profile-hr-menu' class="profile-hr-menu visible-lg">
						<?php echo ossn_plugin_view('menus/green_user_timeline', array('menu_width' => 60)); ?>
					</div>
					<div id='profile-hr-menu' class="profile-hr-menu visible-md">
						<?php echo ossn_plugin_view('menus/green_user_timeline', array('menu_width' => 40)); ?>
					</div>
					<div id='profile-hr-menu' class="profile-hr-menu visible-sm">
						<?php echo ossn_plugin_view('menus/green_user_timeline', array('menu_width' => 25)); ?>
					</div>
					<div id='profile-hr-menu' class="profile-hr-menu visible-xs">
						<?php echo ossn_plugin_view('menus/green_user_timeline', array('menu_width' => 1)); ?>
					</div>
